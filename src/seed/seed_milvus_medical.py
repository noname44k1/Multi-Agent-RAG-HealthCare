...
def seed_milvus(URI_link: str, collection_name: str, filename: str, directory: str, use_ollama: bool = False) -> Milvus:
    ...
    if use_ollama:
        embeddings = OllamaEmbeddings(
            model="llama3.3"  # hoặc model khác mà bạn đã cài đặt
        )
    else:
...
def main():
    ...
    seed_milvus('http://localhost:19530', 'BoYTe_QA', 'moh_qa.json', '/Users/daomanh/Desktop/Build-An-LLM-RAG-Chatbot-With-LangChain-Python/Dataset/data/BoYTe/', use_ollama=False)
